...
CREATE TABLE IF NOT EXISTS product (
    ...
    advertising_cost_per_unit NUMERIC NOT NULL DEFAULT 0 CHECK (advertising_cost_per_unit >= 0),
    average_unit_cost NUMERIC NOT NULL DEFAULT 0 CHECK (average_unit_cost >= 0),
    image BLOB,
    image_content_type TEXT,
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS production_batch (
    ...
    unit_cost NUMERIC NOT NULL CHECK (unit_cost >= 0),
    total_cost NUMERIC NOT NULL CHECK (total_cost >= 0),
    advertising_cost NUMERIC NOT NULL DEFAULT 0 CHECK (advertising_cost >= 0),
