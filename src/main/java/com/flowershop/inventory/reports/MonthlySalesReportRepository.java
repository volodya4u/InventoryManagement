    ...
    SalesTotals findSalesTotals(LocalDate start, LocalDate endExclusive) {
        return jdbcTemplate.query(
                ...
                (rs, rowNum) -> new SalesTotals(
                        ...
                        SqliteDecimals.read(rs, "units_sold"),
                        SqliteDecimals.read(rs, "gross_revenue"),
                        SqliteDecimals.read(rs, "gross_cost")),
                start.toString(),
    ...
    ReturnTotals findReturnTotals(LocalDate start, LocalDate endExclusive) {
        return jdbcTemplate.query(
                ...
                (rs, rowNum) -> new ReturnTotals(
                        ...
                        SqliteDecimals.read(rs, "units_returned"),
                        SqliteDecimals.read(rs, "refunds"),
    ...
    List<ProductSummary> findProductSummaries(LocalDate start, LocalDate endExclusive) {
        return jdbcTemplate.query(
                ...
                (rs, rowNum) -> productSummary(
                        ...
                        SqliteDecimals.read(rs, "quantity_sold"),
                        SqliteDecimals.read(rs, "quantity_returned"),
                        SqliteDecimals.read(rs, "gross_revenue"),
                        SqliteDecimals.read(rs, "refunds"),
                        SqliteDecimals.read(rs, "gross_cost"),
                        SqliteDecimals.read(rs, "returned_cost")),
    ...
    List<SaleSummary> findSales(LocalDate start, LocalDate endExclusive) {
        return jdbcTemplate.query(
                ...
                (rs, rowNum) -> new SaleSummary(
                        ...
                        SqliteDecimals.read(rs, "units_sold"),
                        SqliteDecimals.read(rs, "revenue"),
                        SqliteDecimals.read(rs, "refunds"),
                        SqliteDecimals.read(rs, "revenue").subtract(SqliteDecimals.read(rs, "refunds")),
                        SqliteDecimals.read(rs, "net_cost"),
                        SqliteDecimals.read(rs, "net_profit")),
                start.toString(),
                endExclusive.toString());
    }
